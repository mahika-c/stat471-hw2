...
```
    ...
    Our intial thought is to do a multiple regression with the variables Intelligence, BMI, and Education05. The y variable is Esteem_PC1.
```{r}
...
```{r}
# run regression with these variables
fit1 <- lm(Esteem_PC1 ~ Intelligence, data = merged_df) 
summary(fit1)
...
```{r}
# run regression with these variables
fit1 <- lm(Esteem_PC1 ~ BMI, data = merged_df) 
summary(fit1)
